...
class RelatorioCubit extends Cubit<RelatorioState> {
  ...
  ProductDetailsReportData _buildProductDetails(RelatorioLoaded currentState, Product product) {
    final entradas = _movementReportService.buildMovements(currentState.entryInvoices, product);
    final saidas = _movementReportService.buildMovements(currentState.exitInvoices, product);
