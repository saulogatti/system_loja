...
AppSettingsEntry _$AppSettingsEntryFromJson(Map<String, dynamic> json) => AppSettingsEntry(
  ...
  corPrimaria:
      $enumDecodeNullable(_$EnumColorAppThemeSettingsEnumMap, json['corPrimaria']) ??
  ...
  tempoBloqueioMinutos: (json['tempoBloqueioMinutos'] as num?)?.toInt() ?? 15,
  permitirMultiplosUsuarios: json['permitirMultiplosUsuarios'] as bool? ?? false,
);

Map<String, dynamic> _$AppSettingsEntryToJson(AppSettingsEntry instance) => <String, dynamic>{
