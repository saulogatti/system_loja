...
IndividualEntry _$IndividualEntryFromJson(Map<String, dynamic> json) => IndividualEntry(
...
Map<String, dynamic> _$IndividualEntryToJson(IndividualEntry instance) => <String, dynamic>{
  'name': instance.name,
