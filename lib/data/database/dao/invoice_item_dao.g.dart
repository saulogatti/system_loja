...
mixin _$InvoiceItemDaoMixin on DatabaseAccessor<AppDatabase> {
  $InvoiceItemsRecordsTable get invoiceItemsRecords => attachedDatabase.invoiceItemsRecords;
...
class InvoiceItemDaoManager {
  ...
  $$InvoiceItemsRecordsTableTableManager get invoiceItemsRecords =>
      $$InvoiceItemsRecordsTableTableManager(_db.attachedDatabase, _db.invoiceItemsRecords);
}
