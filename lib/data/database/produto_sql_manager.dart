...
class ProdutoSqlManager {
  ...
  ProdutoSqlManager({DatabaseHelper? dbHelper}) : _dbHelper = dbHelper ?? DatabaseHelper();
  ...
  Future<int> contarTotal() async {
    ...
    final result = await db.rawQuery('SELECT COUNT(*) as total FROM ${DatabaseConfig.tableProdutos}');
  ...
  Future<int> excluir(int id) async {
    ...
    return await db.delete(DatabaseConfig.tableProdutos, where: 'id = ?', whereArgs: [id]);
  }
