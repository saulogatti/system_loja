...
SystemConfigurationData _$SystemConfigurationDataFromJson(
  ...
  productCategories:
      (json['productCategories'] as List<dynamic>?)
          ...
          .toList() ??
      [],
  systemUserData: SystemConfigurationData._systemUserDataFromJson(
    json['systemUserData'],
  ),
);

Map<String, dynamic> _$SystemConfigurationDataToJson(
  SystemConfigurationData instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'systemUserData': SystemConfigurationData._systemUserDataToJson(
