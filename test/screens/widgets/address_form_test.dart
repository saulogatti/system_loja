...
void main() {
  testWidgets('AddressForm fields have correct keyboardType, autofillHints, and textInputAction', (
    WidgetTester tester,
  ) async {
    ...
    expect(fields[0].autofillHints, contains(AutofillHints.streetAddressLine1));
    ...
    expect(find.widgetWithText(DropdownButtonFormField<BrazilianState>, 'Estado'), findsOneWidget);
  });
}
